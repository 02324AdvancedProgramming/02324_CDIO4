...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "cdio4" because\n';
 ...
 * "/cdio4.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['cdio4'].superdevmode = true;

  var expectedSuffix = '/cdio4.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + cdio4 + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:cdio4';
  var devModeSessionKey = '__gwtDevModeSession:cdio4';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/cdio4/cdio4.nocache.js';
  ...
  $wnd.__gwt_activeModules['cdio4'].canRedirect = true;
  $wnd.__gwt_activeModules['cdio4'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/cdio4?user.agent=' + ua + '&_callback=' + callback;
